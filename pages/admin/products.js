  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Deeshee reducer-ruu product info-g ORDER MODEL-d zaasan byh medeeleltei ni PASS hiij bn
    ...
    if (successDelete) {
      ...
      // prevent from fetchData 2 times, insert it into else block
      fetchData()
    }
  }, [successDelete])
